...
import 'package:finalapi/utilities/constants.dart';

import 'package:finalapi/jobs/addjob.dart';
...
class  _Sponsor extends State< Sponsor> {
  ...
  Widget _lastname() {
    return Container(
      ...
      decoration: kBoxDecorationStyle,
      height: MediaQuery.of(context).size.height / 13,//50.0,
      width: 153.0,
      child: TextField(
        keyboardType: TextInputType.emailAddress,
        style: TextStyle(
  ...
  Widget _Manage() {
    return DropdownButtonFormField(
      ...
      decoration: new InputDecoration(
        ...
        labelText: "Chose Tybe Of Managment",
        // labelStyle: ,
        //  hintStyle: kHintTextStyle,
        //icon: new Icon(Icons.person)
      ),
                          ...
                          child: Stack(
                            ...
                            children: <Widget>[
                              ListView(
                                children: <Widget>[
                                  Container(
                                    height: MediaQuery.of(context).size.height * 1.7,//height: 1000.0,
